...
$sqlAbout = "SELECT * FROM `about_bd_constitution`";
...
?>
        ...
        <div class="content">
            ...
            <div class="row animated fadeInRight">
                <!--BASIC-->
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>About Bangladesh Law & Constitution</b></h4>
                    <a class="btn btn-primary" href="<?php echo SITEURL ?>manage_about_constitution.php?target=add&id=0">
                     Add New 
                    </a>
                    <div class="panel">
                        <div class="panel-content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
                                    while($About = mysqli_fetch_array($resAbout)){
                                        ?>
                                        <tr>
                                            <td><?php echo $count++ ?></td>
                                            <td><?php echo $About['title'] ?></td>
                                            <td>
                                                <a class="m-1 btn btn-primary btn pt-5" href="<?php echo SITEURL ?>manage_about_constitution.php?target=view&id=<?php echo $About['id']; ?>" role="button">
                                                    View
                                                </a>
                                                <a onclick="return confirm('Are you sure, You want to delete this image !!');" class="m-1 btn btn-danger btn" href="<?php echo SITEURL ?>edit_homepage.php?btn=delete&id=<?php echo $About['id']; ?>" role="button">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
...
if(isset($_GET['btn']) && $_GET['btn']=='delete'){
  $id = $_GET['id'];
  $deleteQuery = "DELETE FROM about_bd_constitution WHERE id = '$id'";
  ...
  if($resDelete){
    ...
    ?>
     <script type="text/javascript">
        window.location.href = '<?php echo SITEURL; ?>edit_homepage.php';
    </script>
  <?php
  }else{
