...
$sqlNotice = "SELECT * FROM `notice_board`";
$resNotice = mysqli_query($conn, $sqlNotice);
...
?>
        ...
        <div class="content">
            ...
            <div class="row animated fadeInRight">
                <!--BASIC-->
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>Notice Board</b></h4>
                    <a class="btn btn-primary" href="<?php echo SITEURL ?>manage_notice.php?target=add&id=0">
                     Add New 
                    </a>
                    <div class="panel">
                        <div class="panel-content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
                                    while($Notice = mysqli_fetch_array($resNotice)){
                                        ?>
                                        <tr>
                                            <td><?php echo $count++ ?></td>
                                            <td><?php echo $Notice['title'] ?></td>
                                            <td>
                                                <a class="m-1 btn btn-primary btn pt-5" href="<?php echo SITEURL ?>manage_notice.php?target=view&id=<?php echo $Notice['id']; ?>" role="button">
                                                    View
                                                </a>
                                                <a onclick="return confirm('Are you sure, You want to delete this notice !!');" class="m-1 btn btn-danger btn" href="<?php echo SITEURL ?>notice_board.php?btn=delete&id=<?php echo $Notice['id']; ?>" role="button">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
...
if(isset($_GET['btn']) && $_GET['btn']=='delete'){
  $id = $_GET['id'];
  $deleteQuery = "DELETE FROM notice_board WHERE id = '$id'";
  ...
  <?php
    ...
    $_SESSION['delete'] = "<div class='text-danger text-center py-3'><strong?> The Deletation of the notice Failed </strong></div>";
    ?>
    <script type="text/javascript">
        window.location.href = '<?php echo SITEURL; ?>notice_board.php';
    </script>
