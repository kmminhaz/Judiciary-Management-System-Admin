        ...
        <div class="mt-5 pt-5 col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card shadow-lg" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h4 class="text-uppercase text-center mb-5 fw-bold">Manage About Bangladesh & It's Constitution</h4>

            <?php
                $aboutId = $_GET['id'];
                $aboutTarget = $_GET['target'];
              
                $sql = "SELECT * FROM `about_bd_constitution` WHERE `id` = '$aboutId'";
...
if(isset($_POST['add'])){
    ...
    $sqladd = "INSERT INTO `about_bd_constitution` (`title`, `description`) 
...
if(isset($_POST['update'])){
    ...
    $sqlupdate = "UPDATE `about_bd_constitution`
...
<?php
    if(isset($_POST['delete'])){
        $deleteQuery = "DELETE FROM about_bd_constitution WHERE id = '$aboutId'";
