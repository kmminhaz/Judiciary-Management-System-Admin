...
$sqlNLinks = "SELECT * FROM `necessery_links`";
$resNLinks = mysqli_query($conn, $sqlNLinks);
...
?>
        ...
        <div class="content">
            ...
            <div class="row animated fadeInRight">
                <!--BASIC-->
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>Necessery Links</b></h4>
                    <a class="btn btn-primary" href="<?php echo SITEURL ?>manage_nlinks.php?target=add&id=0">
                     Add New 
                    </a>
                    <div class="panel">
                        <div class="panel-content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
                                    while($NLinks = mysqli_fetch_array($resNLinks)){
                                        ?>
                                        <tr>
                                            <td><?php echo $count++ ?></td>
                                            <td><?php echo $NLinks['title'] ?></td>
                                            <td>
                                                <a class="m-1 btn btn-primary btn pt-5" href="<?php echo SITEURL ?>manage_nlinks.php?target=view&id=<?php echo $NLinks['id']; ?>" role="button">
                                                    View
                                                </a>
                                                <a onclick="return confirm('Are you sure, You want to delete this Link !!');" class="m-1 btn btn-danger btn" href="<?php echo SITEURL ?>necessery_links.php?btn=delete&id=<?php echo $NLinks['id']; ?>" role="button">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
...
if(isset($_GET['btn']) && $_GET['btn']=='delete'){
  $id = $_GET['id'];
  $deleteQuery = "DELETE FROM `necessery_links` WHERE id = '$id'";
  ...
  <?php
    ...
    $_SESSION['delete'] = "<div class='text-danger text-center py-3'><strong?> The Deletation of the Link Failed </strong></div>";
    ?>
    <script type="text/javascript">
        window.location.href = '<?php echo SITEURL; ?>necessery_links.php';
    </script>
