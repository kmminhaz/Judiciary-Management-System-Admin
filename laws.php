...
$sqlLawLink = "SELECT * FROM `laws_link`";
$resLawLink = mysqli_query($conn, $sqlLawLink);
...
?>
        ...
        <div class="content">
            ...
            <div class="row animated fadeInRight">
                <!--BASIC-->
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>Laws</b></h4>
                    <a class="btn btn-primary" href="<?php echo SITEURL ?>manage_laws.php?target=add&id=0">
                     Add New 
                    </a>
                    <div class="panel">
                        <div class="panel-content">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
                                    while($LawLinks = mysqli_fetch_array($resLawLink)){
                                        ?>
                                        <tr>
                                            <td><?php echo $count++ ?></td>
                                            <td><?php echo $LawLinks['title'] ?></td>
                                            <td>
                                                <a class="m-1 btn btn-primary btn pt-5" href="<?php echo SITEURL ?>manage_laws.php?target=view&id=<?php echo $LawLinks['id']; ?>" role="button">
                                                    View
                                                </a>
                                                <a onclick="return confirm('Are you sure, You want to delete this Law !!');" class="m-1 btn btn-danger btn" href="<?php echo SITEURL ?>laws.php?btn=delete&id=<?php echo $LawLinks['id']; ?>" role="button">
                                                    Delete
                                                </a>
                                            </td>
                                        </tr>
...
if(isset($_GET['btn']) && $_GET['btn']=='delete'){
  $id = $_GET['id'];
  $deleteQuery = "DELETE FROM `laws_link` WHERE id = '$id'";
  ...
  <?php
    ...
    $_SESSION['delete'] = "<div class='text-danger text-center py-3'><strong?> The Deletation of the Law Failed </strong></div>";
    ?>
    <script type="text/javascript">
        window.location.href = '<?php echo SITEURL; ?>laws.php';
    </script>
