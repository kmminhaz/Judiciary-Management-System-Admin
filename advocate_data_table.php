...
$sqlAdvocates = "SELECT * FROM `advocate_profile`";
$resAdvocates = mysqli_query($conn, $sqlAdvocates);
...
<!-- CONTENT -->
        ...
        <div class="content">
            ...
            <div class="row animated fadeInRight">
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>Advocates</b></h4>
                    <div class="panel">
                        <div class="panel-content">
                            <div class="table-responsive">
                                <table id="basic-table" class="data-table table table-striped nowrap table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <th>Advocates ID</th>
                                        <th>Advocates Name</th>
                                        <th>Phone</th>
                                        <th>Address</th>
                                        <th>Image</th>
                                        <th>Advocates Email</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                <?php
                                while($advocates = mysqli_fetch_array($resAdvocates)){
                                    ?>
                                    <tr>
                                        <td><?php echo $advocates['advocateId'] ?></td>
                                        <td><?php echo $advocates['full_name'] ?></td>
                                        <td><?php echo $advocates['phoneNo'] ?></td>
                                        <td><?php echo $advocates['address'] ?></td>
                                        <td><?php echo $advocates['image'] ?></td>
                                        <td><?php echo $advocates['email'] ?></td>
                                        <td>
                                            <a class="m-1 btn btn-primary btn" href="<?php echo SITEURL ?>advocatesOperation.php?target=advocate&id=<?php echo $advocates['id']; ?>" role="button">
                                                View
                                            </a>
                                        </td>
                                    </tr>
