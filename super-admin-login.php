...
<div class="wrap">
    ...
    <div class="page-body animated slideInDown">
        ...
        <!--LOGO-->
        <div>
            <h3 class="text-dark fw-bold text-center"> S U P E R -{ A D M I N }- </h3>
        </div>
        <div class="box">
            <!--SIGN IN FORM-->
...
if (isset($_POST['submit'])) {
    ...
    if ($count == 1) {
      $rows = mysqli_fetch_array($res);
        ...
        $_SESSION['Super-User'] = 'Super Admin';
?>
        <script type="text/javascript">
            window.location.href = '<?php echo SITEURL; ?>pages_admin-profile.php';
        </script>
    <?php
    } else {
